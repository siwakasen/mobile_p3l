...
class _MOHomeScreenState extends State<MOHomeScreen> {
  ...
  Future<List<Presensi>> getPresensi() async {
    List<Presensi> data =
        await _presensiController.getPresensi(token!, dateInput.text);
    setState(() {
      listPresensi = data;
    });
    return data;
  ...
  List<Presensi> searchPresensi(String query) {
    ...
    List<Presensi> result = listPresensi
        .where((element) => element.karyawan.nama_karyawan
            .toLowerCase()
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        Text(convertDateFormat(dateInput.text),
                            style: TextStyle(
                                color: Colors.black,
                                fontFamily: 'Poppins',
                                fontSize: 16.sp,
                            ...
                            child: ListTile(
                              title: Text(
                                  ...
                                  style: TextStyle(
                                      ...
                                      fontSize: 16.sp,
                                      fontWeight: FontWeight.w500)),
                              subtitle: Text(listPresensi[index].status,
                                  style: TextStyle(
                                      color: Colors.black,
                                      fontFamily: 'Poppins',
                                      fontSize: 14.sp,
                              ...
                              trailing: DropdownButton(
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    updatePresensi(
                                        listPresensi[index].id_presensi,
                                        value.toString());
                                  });
                                },
                              ),
