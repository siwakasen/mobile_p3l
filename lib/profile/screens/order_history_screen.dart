...
import 'package:mobile_p3l/profile/controllers/order_history_controller.dart';
...
class _OrderHistoryScreenState extends State<OrderHistoryScreen> {
  String? token;
  final OrderHistoryController _orderHistoryController = OrderHistoryController();
  ...
  Future<List<Pesanan>> searchOrderHistory(String query) async {
    ...
    List<Pesanan> result = data.where((element) {
      return element.detail_pesanan.any((e) {
        return e.produk != null ? e.produk!.nama_produk.toLowerCase().contains(query.toLowerCase()) : e.hampers!.nama_hampers.toLowerCase().contains(query.toLowerCase());
      });
    }).toList();
    return result;
  }
                  ...
                  return Container(
                    ...
                    child: Column(
                      children: [
                          ...
                          child: Row(
                            children: [
                              ...
                              Chip(
                                ...
                                backgroundColor: orderHistory[index].status_transaksi == "Pesanan Sudah Selesai" ? indigo[500] : red[400],
                              )
                            ],
                          ),
                        ),
                        ...
                        Column(
                          children: (
                            orderHistory[index].detail_pesanan.map((e) {
                              return Column(
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.symmetric(horizontal: 5),
                                    child: Row(
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              e.produk != null ? e.produk!.nama_produk : e.hampers!.nama_hampers,
                                              style: TextStyle(
                                                fontSize: 14.sp,
                                                fontWeight: FontWeight.w600,
                                                fontFamily: 'Poppins',
